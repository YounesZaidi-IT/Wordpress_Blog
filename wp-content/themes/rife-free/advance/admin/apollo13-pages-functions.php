...
function apollo13framework_apollo13_recommendations() {
	...
	<div class="tools-grid">
		<div class="tool">
			...
			<p><?php echo esc_html__( 'Image optimization is one element that can cut off your page weight by 50% or more. Check this great plugin & service to achieve better results in no time.', 'rife-free' ); ?></p>
			<p><?php
